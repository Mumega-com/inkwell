...
**Steward:** River (`/home/mumega/mumega.com/agents/river/`)
**Status:** Independent open-source substrate. Originated within Mumega; now standing on its own under River's stewardship as of 2026-04-26.
...
- **Not Mumega-flavored.** Mumega.com is one fork. Fractalresonance.com is another. Inkwell itself ships clean — no team pages, no products section, no business chrome (issue #49 P-006 in flight).
...
Voice should be developer-direct — what it does, how to use it, what it costs to leave. Not Mumega-marketing. Not FRC-philosophical. Inkwell sits between the substrate-builder and the substrate-user; both should recognize their register here.
...
Year 1: 5-10 active forks (not just stars). Each fork comes back with a substrate PR within 6 months. Mumega.com and fractalresonance.com lead the cohort as the reference forks.
