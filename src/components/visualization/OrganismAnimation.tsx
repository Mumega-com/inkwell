...
function Shell() {
  ...
  return (
    <svg width={1280} height={720} style={{ position: 'absolute', inset: 0, display: 'block' }}>
      ...
      <PxText x={640} y={35} text="MUMEGA — ORGANISM RUNTIME" size={20} color={OF.frame} align="center" />
      ...
      <PxText x={18} y={704} text="MUMEGA SaaS · inkwell.dev kernel · CF Workers" size={13} color={OF.dim} />
...
export function OrganismAnimation({ height = '100%' }: { height?: string | number }) {
  return (
    <div style={{ width: '100%', height }}>
      <Stage duration={48} loop background={OF.bg} persistKey="mumega-organism-anim" showControls>
