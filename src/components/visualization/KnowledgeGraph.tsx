...
export function KnowledgeGraph({ nodes: initialNodes, edges }: KnowledgeGraphProps) {
  ...
  const simulate = useCallback(() => {
    ...
    // ⚡ Bolt: Optimize physics calculation
    // - Central gravity is evaluated once per node.
    // - Node repulsion uses unique pairs, halving iterations from O(N²) to O(N²/2) via Newton's 3rd law.
