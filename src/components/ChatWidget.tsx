...
interface ChatWidgetProps {
  ...
  reference?: string
  workerUrl?: string
  /** Display name shown in the panel header. Defaults to "Assistant". */
  agentName?: string
  /** Greeting shown when the chat is empty. */
  greeting?: string
  /** Support phone number shown in error messages. Optional. */
  supportPhone?: string
}
...
export function ChatWidget({
  ...
  const defaultGreeting = greeting ?? `Hi! I'm the ${agentName}. How can I help you today?`
  const errorMsg = supportPhone
    ? `Sorry, I couldn't connect. Please try again or call ${supportPhone}.`
  ...
  }, [input, loading, messages, reference, workerUrl, errorMsg])
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      <div role="dialog" aria-label={`${agentName} chat`} aria-modal="true" style={panelStyle}>
        {/* Header */}
