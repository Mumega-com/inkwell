...
const EXCLUSIONS = [
  ...
  'Customer is solely responsible for purchasing adequate marine cargo insurance. Carrier is not liable for loss or damage without insurance coverage.',
  ...
  return (
    <form onSubmit={handleSubmit} className="contract-form">
      ...
      <section className="cf-section">
        ...
        <p className="cf-help">Select your preferred insurance coverage. We strongly recommend All Risk coverage for international shipments.</p>
