...
interface MovingQuoteFormProps {
  apiBase?: string
  /** Company name shown in the legal disclaimer. Defaults to "us". */
  companyName?: string
}
...
export function MovingQuoteForm({ apiBase = '', companyName = 'us' }: MovingQuoteFormProps) {
  ...
  if (submitted) {
    return (
      <div className="mq-success">
        ...
        <p className="mq-success-sub">Questions? <a href="tel:">Call us</a></p>
      </div>
    )
  }
  ...
  return (
    <form className="mq-form" onSubmit={handleSubmit} noValidate>
      ...
      <p className="mq-legal">
        By submitting you agree to be contacted by {companyName} regarding your moving quote.
