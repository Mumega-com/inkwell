...
// ⚡ Bolt: Cache Intl.NumberFormat instance at module level to avoid expensive GC/instantiation inside render loops
const compactNumberFormat = new Intl.NumberFormat('en-CA', { notation: 'compact' })
          ...
          <div>
            ...
            <div style={{ padding: '0.8rem 1.5rem', borderBottom: '1px solid var(--ink-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ color: 'var(--ink-text)', fontSize: '1.1rem', fontWeight: 700, fontFamily: 'var(--ink-font-mono, monospace)' }}>
                {compactNumberFormat.format(data.totalVisitors)}
              </span>
            </div>
