    ...
    <div style={{ padding: '24px 16px 16px' }}>
      ...
      {!dismissedLastLogin && me?.createdAt && (
        ...
        >
          <span>
            Last login:{' '}
            {/* OPTIMIZATION: Use cached getDateTimeFormatter instead of new Date().toLocaleString() to avoid expensive Intl object instantiation overhead during re-renders */}
