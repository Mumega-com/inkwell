...
function formatCents(cents: number): string {
  // Use cached formatter to improve performance during frequent render cycles
                  ...
                  <TableBody>
                    {contracts.map(c => (
                      <TableRow key={c.reference}>
                        ...
                        <TableCell className="font-mono text-sm">{c.rate ? `$${getNumberFormatter(undefined).format(c.rate)}` : '—'}</TableCell>
