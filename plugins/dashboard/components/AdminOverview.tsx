...
function formatCents(cents: number): string {
  // OPTIMIZATION: Use cached getCurrencyFormatter instead of Number.toLocaleString() to avoid expensive Intl object instantiation overhead during re-renders, especially inside list iterations.
