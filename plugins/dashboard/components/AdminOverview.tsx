...
function formatCents(cents: number): string {
  // Use cached formatter to avoid repetitive Intl instantiation
                  ...
                  <TableBody>
                    {contracts.map(c => (
                      <TableRow key={c.reference}>
                        ...
                        <TableCell className="font-mono text-sm">{c.rate != null ? getNumberFormatter('en-US', { style: 'currency', currency: 'USD' }).format(c.rate) : '—'}</TableCell>
