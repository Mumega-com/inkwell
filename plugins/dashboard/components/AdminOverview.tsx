...
function formatCents(cents: number): string {
  return getCurrencyFormatter('en-US', 'USD', { minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(cents / 100)
}
                  ...
                  <TableBody>
                    {contracts.map(c => (
                      <TableRow key={c.reference}>
                        ...
                        <TableCell className="font-mono text-sm">{c.rate != null ? getCurrencyFormatter('en-US', 'USD', { minimumFractionDigits: 0, maximumFractionDigits: 2 }).format(c.rate) : '—'}</TableCell>
