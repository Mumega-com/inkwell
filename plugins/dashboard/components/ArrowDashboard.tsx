...
function formatCurrency(n: number): string {
  return getFormatter('en-CA', { style: 'currency', currency: 'CAD', maximumFractionDigits: 0 }).format(n)
}

function formatCompact(n: number): string {
  return getFormatter('en-CA', { notation: 'compact', maximumFractionDigits: 1 }).format(n)
}
