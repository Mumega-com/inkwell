...
function formatCurrency(n: number): string {
  return getNumberFormatter({ locales: 'en-CA', style: 'currency', currency: 'CAD', maximumFractionDigits: 0 }).format(n)
}

function formatCompact(n: number): string {
  return getNumberFormatter({ locales: 'en-CA', notation: 'compact', maximumFractionDigits: 1 }).format(n)
}
