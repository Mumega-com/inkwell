    ...
    >
      ...
      <div className="p-3 flex flex-col gap-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          {getDateTimeFormatter(undefined).format(new Date(asset.createdAt))}
          {' \u00B7 '}
      ...
      >
        ...
        {(() => {
          const rows: [string, string][] = [
            ...
            ['Source', asset.sourceType], ['Created', getDateTimeFormatter(undefined, { dateStyle: 'short', timeStyle: 'short' }).format(new Date(asset.createdAt))],
          ]
