...
|---------------|---------------------|----------------------------------------------|
| `acme`    | `acme`              | wrangler project name, workflow names, config |
| `Acme Co`   | `Acme Co`           | site title, brand name, SEO org name         |
| ``  | `acme.com`          | URLs, SITE_URL var, worker URL               |
| `owner@acme.com`   | `owner@acme.com`    | about page contact                           |
| ``| `consulting`        | SEO knowsAbout, about page                   |
| `` | `Doing the thing.`  | meta description, hero subtitle              |
